package com.example.rafaelvilla.mobilieapplicationtest.Utilities
...
object KeyDictionary{
    ...
    val defautlBool = true

    val imageURLs = listOf("http://t1.gstatic.com/images?q=tbn:ANd9GcS0cjDhf5MPvwP-yjPWeAJMSsrAEbQoFeRQU78-B-F0fftw5OdBrwr4o1Uy",
